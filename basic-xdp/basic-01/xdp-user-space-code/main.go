...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang xdp_pass_kern ../xdp-kernel-space-code/xdp_prog.c

var iface string

// to store the program object
type Collect struct {
	Prog *ebpf.Program `ebpf:"xdp_prog_main"`
}
